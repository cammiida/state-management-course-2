const localStateTasks: string[] = [
  ...
  `Connect the input to the argument passed to useFetch so that it is
        ...
        '/posts' if it is empty.`,
  "Use the loading and error variables returned from the useFetch hook to display a 'loading' string or the error message for loading or errors, respectively.",
];
